  ...
  \cventry
    ...
    {Nov.2021 - Heute} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Entwicklung von Python-Werkzeugen zur Automatisierung von leistungselektronischen Schaltungssimulationen mit PLECS}
        \item {Entwicklung von Python-Werkzeugen zur Finalisierung und Vergleichung der Ergebnisse der Simulationen}
        \item {Automatisierung der Geneierung verschiedener Arten von Diagrammen(3D-Wireframes, gestapelte Balkendiagramme usw.) je nach Eigenschaften der Daten}
        \item {Anpassungen in PLECS-Modellen}
        \item {Documentation der Skripten}
      \end{cvitems}
    }
